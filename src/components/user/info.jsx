    ...
    <div className={styles.info}>
      <div className={styles.basicInfo}>
        ...
        <div className={styles.mation}>
          ...
          <p className={`${styles.desc} text-two`}>
            {' '}
            {userInfo.company}@{userInfo.job}
          </p>
        </div>
      </div>
      ...
      <div className={styles.statistical}>
        <div className={styles.item}>
          ...
          <div className={styles.count}>{statistical.postCount}</div>
        </div>
        <Divider type="vertical" />
        <div className={styles.item}>
          <div className={styles.title}>关注</div>
          <div className={styles.count}>{statistical.myFocusNum}</div>
        </div>
        <Divider type="vertical" />
        <div className={styles.item}>
          <div className={styles.title}>关注者</div>
          <div className={styles.count}>{statistical.focusMyNum}</div>
        </div>
      </div>
    </div>
  );
