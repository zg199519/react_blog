    ...
    return (
      <div className={styles.home}>
        ...
        <div className={styles.advertising}>
          <img
            src={this.state.advertising.img}
            alt={this.state.advertising.name}
          />
              ...
              return (
                <li className={styles.item} key={index}>
                  ...
                  <div className={styles.info}>
                    <div className={`${styles.name} text-line`}>
                      {item.name}
                    </div>
            ...
            {this.state.smallVolumes.map((item, index) => {
              return (
                <li className={styles.item} key={index}>
                  ...
                  ></div>
                  <div className={styles.info}>
                    <div className={`${styles.name} text-two`}>
                      {item.title}
                    </div>
